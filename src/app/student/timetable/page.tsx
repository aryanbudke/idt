...
const SCHEDULE: Record<string, Record<string, { subject: string; faculty: string; room: string } | null>> = {
  Monday: { "10:00": { subject: "Intro to Programming", faculty: "Dr. Mitchell", room: "101" }, "14:00": { subject: "Discrete Math", faculty: "Dr. Wilson", room: "201" } },
  Tuesday: { "09:00": { subject: "Data Structures", faculty: "Prof. Chen", room: "LAB-01" }, "14:00": { subject: "Digital Logic", faculty: "Dr. Brown", room: "201" } },
  Wednesday: { "10:00": { subject: "Intro to Programming", faculty: "Dr. Mitchell", room: "101" }, "13:00": { subject: "Discrete Math", faculty: "Dr. Wilson", room: "102" } },
  Thursday: { "09:00": { subject: "Data Structures", faculty: "Prof. Chen", room: "LAB-01" }, "14:00": { subject: "Digital Logic", faculty: "Dr. Brown", room: "201" } },
  Friday: { "10:00": { subject: "Intro to Programming", faculty: "Dr. Mitchell", room: "101" }, "12:00": { subject: "Discrete Math", faculty: "Dr. Wilson", room: "103" } },
};
...
export default function StudentTimetablePage() {
  return (
    <div className="space-y-6">
      <div><h1 className="text-h2 font-bold tracking-tight text-on-surface">Timetable</h1><p className="mt-1 text-body-sm text-on-surface-variant">Your weekly class schedule – Fall 2024</p></div>
                      ...
                      <td key={day} className="px-2 py-2">
                        {slot ? (
                          <div className={`rounded-lg border p-2.5 text-xs ${getColor(slot.subject)}`}>
                            ...
                            <p className="mt-1 opacity-75">{slot.faculty}</p>
                            <p className="opacity-75">{slot.room}</p>
                          </div>
                        ) : null}
                      </td>
                    );
